...
from fourms.views import forumView, editForum, deleteForum, fullForum, deletePost, editPost, subForum, unsubForum, viewPost
...
urlpatterns = [
    ...
    url(r'^(?P<username>\w+)/forum/(?P<slug>[\w-]+)/subscribe/$', subForum, name='subForum'),
    url(r'^(?P<username>\w+)/forum/(?P<slug>[\w-]+)/unsubscribe/$', unsubForum, name='unsubForum'),
    ...
    url(r'^(?P<username>\w+)/forum/post/(?P<slug>[\w-]+)/$', viewPost, name='viewPost'),
    url(r'^(?P<username>\w+)/forum/post/(?P<slug>[\w-]+)/edit/$', editPost, name='editPost'),
    url(r'^(?P<username>\w+)/forum/post/(?P<slug>[\w-]+)/delete/$', deletePost, name='deletePost'),
